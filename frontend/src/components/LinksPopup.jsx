...
export default function LinksPopup(props) {
  ...
  return props.popup?(
    <div className='popup-education' id="popupedu">
      ...
      <input type="text" id="in11" className='linkname' defaultValue={givenarr[0]?givenarr[0][0]:""}/>:
      <input type="text" id="in12" className='linklink' defaultValue={givenarr[0]?givenarr[0][1]:""}/>
    </div>
      <div className='popuplinkfield'>
      <input type="text" id="in21" className='linkname' defaultValue={givenarr[1]?givenarr[1][0]:""}/>:
      <input type="text" id="in22" className='linklink' defaultValue={givenarr[1]?givenarr[1][1]:""}/>
    </div>
      <div className='popuplinkfield'>
      <input type="text" id="in31" className='linkname' defaultValue={givenarr[2]?givenarr[2][0]:""}/>:
      <input type="text" id="in32" className='linklink' defaultValue={givenarr[2]?givenarr[2][1]:""}/>
    </div>
      <div className='popuplinkfield'>
      <input type="text" id="in41" className='linkname' defaultValue={givenarr[3]?givenarr[3][0]:""}/>:
      <input type="text" id="in42" className='linklink' defaultValue={givenarr[3]?givenarr[3][1]:""}/>
    </div>
      <div className='popuplinkfield'>
      <input type="text" id="in51" className='linkname' defaultValue={givenarr[4]?givenarr[4][0]:""}/>:
      <input type="text" id="in52" className='linklink' defaultValue={givenarr[4]?givenarr[4][1]:""}/>
    </div>
      <div className='popuplinkfield'>
      <input type="text" id="in61" className='linkname' defaultValue={givenarr[5]?givenarr[5][0]:""}/>:
      <input type="text" id="in62" className='linklink' defaultValue={givenarr[5]?givenarr[5][1]:""}/>
    </div>
      <div className='popuplinkfield'>
      <input type="text" id="in71" className='linkname' defaultValue={givenarr[6]?givenarr[6][0]:""}/>:
      <input type="text" id="in72" className='linklink' defaultValue={givenarr[6]?givenarr[6][1]:""}/>
    </div>
